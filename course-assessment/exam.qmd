...
Every two weeks, in one of the courses, we will assign you a problem set (*Übungsblatt*). You will typically have at least one week to complete and submit your solutions. Please send me your submissions rendered as pdf or html **via Mail**.

## Formatting and Technical Requirements

Your submissions must be a fully **rendered PDF or HTML document**.



To ensure clarity, readability and reproducibility as well as to save me from the trouble of rendering your document myself:

- Your document must be **fully rendered** (no raw .qmd or .Rmd files)
- Include all **code, output and graphics** directly in the document.
- Each exercise should:
  - Begin with a clear heading (e.g. `# Exercise 1`)
  - Contain well structured solution steps, including code and explanations.
...
If you chose to use AI-Applications for assignments that you hand in in this course, please just mark the corresponding number somehow. For these answers I will only check, if the result is correct ans spare my time from correcting a language model. 